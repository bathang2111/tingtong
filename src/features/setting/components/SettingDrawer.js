...
function SettingDrawer({ open, onClose }) {
    ...
    return (
        ...
        >
            {!open ? <Avatar className={classes.info} alt="Remy Sharp" src="/static/images/avatar/1.jpg" /> : <div className={classes.info}>
                <Avatar alt="Remy Sharp" src="/static/images/avatar/1.jpg" />
                <Typography style={{ "marginTop": "8px" }} variant="h4" component="h2">Donald Trieu</Typography>
                <Typography variant="body2" component="p">donaldtrieu@gmail.com</Typography>
            </div>}
            ...
            <List>
                ...
                <ListItem button>
                    <ListItemIcon> <DuoOutlinedIcon /></ListItemIcon>
